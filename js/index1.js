        ...
        $.ajax({
            ...
            success: function (layersForGroup) {
                ...
                for (var i = 0; i < layersForGroup.length; i++) {
                    sonshtml += "<div class='list-group-item father' flag='0' onclick='showSons(this)' style='cursor:pointer'><input type='checkbox' style='cursor:pointer'>" + "<strong>" + layersForGroup[i].father.DisplayName + "</strong><span class='glyphicon glyphicon-plus' aria-hidden='true'></span></div>"
